...
function theme.at_screen_connect(s)
	...
	-- Set scratchpad to floating
	local scrapTag = awful.tag.find_by_name(awful.screen.focused(), "scratch")
	local newLayout = awful.layout.suit.tile
	awful.layout.set(newLayout, scrapTag)
